...
import {TCPersonalityDisplayerComponent} from "../tcframework/components/tc-personality-displayer.component";
...
@Component({
    ...
    directives: [VCFiveComponent, HeroList, TCPersonalityDisplayerComponent],
